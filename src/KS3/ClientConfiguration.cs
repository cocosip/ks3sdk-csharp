...
namespace KS3
{
    ...
    {
        /*
         The default time-out value in milliseconds for the GetResponse and GetRequestStream methods of the HttpWebRequest. To specify the amount of time to wait for the request to complete, use the Timeout property.
         */
