...
namespace KS3.Model
{
    ...
    public class GetObjectRequest : KS3Request
    {
        ...
        /// </summary>
        public List<string> MatchingETagConstraints { get; set; }
        ...
        /// constraint values.
        /// </summary>
        public List<string> NonmatchingETagContraints { get; set; }
        ...
        {
            Range = new List<long>();
            MatchingETagConstraints = new List<string>();
            NonmatchingETagContraints = new List<string>();
        }
        ...
        public GetObjectRequest(string bucketName, string key) : this()
        {
        ...
        public GetObjectRequest(string bucketName, string key, FileInfo destinationFile) : this(bucketName, key)
        {
