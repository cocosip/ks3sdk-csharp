...
namespace KS3.Model
{
    ...
    public class PutObjectRequest : KS3Request
    {
        ...
        /// <summary>
        /// The file containing the data to be uploaded to KS3.
        /// You must either specify a file or a Stream containing the data to be uploaded to KS3.
        /// </summary>
        public FileInfo File { get; set; }

        /// <summary>
        /// The Stream containing the data to be uploaded to KS3. 
        /// You must either specify a file or an Stream containing the data to be uploaded to KS3.
        /// </summary>
        public Stream InputStream { get; set; }

        /// <summary>
        /// Optional metadata instructing KS3 how to handle the uploaded data (e.g. custom user metadata, 
        /// hooks for specifying content type, etc.). If you are uploading from an Stream,
        /// you <bold>should always</bold> specify metadata with the content size set,
        /// otherwise the contents of the Stream will have to be buffered in memory before they can be sent to KS3,
        /// which can have very negative performance impacts.
        /// </summary>
